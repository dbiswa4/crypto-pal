...
exports.userService = async (req, res) => {
  ...
  try {
    ...
    // nounce
    const nounce = await childWeb3.eth.getTransactionCount(oracle_owner_address)
    ...
    const results_2 = await _payUtilityWithToken({
      token_address: token_of_fee,
      web3: childWeb3,
      from_address: oracle_owner_address,
      nounce: nounce,
      normalized_amount: amount_of_fee,
    ...
    // nounce
    const nounce2 = await childWeb3.eth.getTransactionCount("0x1d8da2d8cf9f631c1a74b97c4458305c195d1111")

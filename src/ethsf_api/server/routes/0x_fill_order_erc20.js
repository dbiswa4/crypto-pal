...
export const scenarioAsync = async ({
  ...
  taker_amount,
    ...
    const makerAssetAmount = Web3Wrapper.toBaseUnitAmount(new BigNumber(maker_amount), DECIMALS);
    console.log("makerAssetAmount: ", makerAssetAmount.toNumber())
    // the amount the maker wants of taker asset
    // const takerAssetAmount = Web3Wrapper.toBaseUnitAmount(new BigNumber(0.1), DECIMALS);
    const takerAssetAmount = Web3Wrapper.toBaseUnitAmount(new BigNumber(taker_amount), DECIMALS);
